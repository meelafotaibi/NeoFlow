...
import { auth, signInWithGoogle, signInWithApple, logoutUser } from "@/lib/firebase";
import {
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <div className="space-y-3">
            ...
            <Button
              ...
              disabled={isLoading}
              className="w-full h-11 bg-black text-white hover:bg-gray-900 font-semibold flex items-center justify-center gap-3"
            >
